defmodule Medplum.Resources.ClaimResponse do
  @moduledoc """
  Convenience helpers for FHIR `ClaimResponse` resource.

  ## Examples

      alias Medplum.Resources.ClaimResponse

      {:ok, responses} = ClaimResponse.search_by_claim(client, "Claim/claim-123")
      {:ok, by_patient} = ClaimResponse.search_by_patient(client, "Patient/patient-123")
  """
  ...
  @spec search_by_claim(Client.t(), String.t(), map()) :: Medplum.result()
  def search_by_claim(%Client{} = client, claim, params \\ %{}) do
    search(client, Map.merge(params, %{"claim" => claim}))
  end
  ...
  @spec search_by_requestor(Client.t(), String.t(), map()) :: Medplum.result()
  def search_by_requestor(%Client{} = client, requestor, params \\ %{}) do
    search(client, Map.merge(params, %{"requestor" => requestor}))
  end
end
