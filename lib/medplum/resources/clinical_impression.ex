defmodule Medplum.Resources.ClinicalImpression do
  @moduledoc """
  Convenience helpers for FHIR `ClinicalImpression` resource.

  ## Examples

      alias Medplum.Resources.ClinicalImpression

      {:ok, impressions} = ClinicalImpression.search_by_patient(client, "Patient/patient-123")
      {:ok, encounter_notes} = ClinicalImpression.search_by_encounter(client, "Encounter/encounter-123")
  """
