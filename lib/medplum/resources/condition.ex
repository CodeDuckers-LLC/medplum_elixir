defmodule Medplum.Resources.Condition do
  @moduledoc """
  Convenience helpers for FHIR `Condition` resource.

  ## Examples

      alias Medplum.Resources.Condition

      {:ok, active} = Condition.search_by_clinical_status(client, "active")
      {:ok, patient_conditions} = Condition.search_by_patient(client, "Patient/patient-123")
  """
