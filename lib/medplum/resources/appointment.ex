defmodule Medplum.Resources.Appointment do
  @moduledoc """
  Convenience helpers for the FHIR `Appointment` resource.

  ## Examples

      alias Medplum.Resources.Appointment

      {:ok, appointment} = Appointment.get(client, "appt-123")
      {:ok, by_patient} = Appointment.search_by_patient(client, "Patient/patient-123")
  """
