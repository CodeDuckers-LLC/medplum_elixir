defmodule Medplum.Resources.Invoice do
  @moduledoc """
  Convenience helpers for FHIR `Invoice` resource.

  ## Examples

      alias Medplum.Resources.Invoice

      {:ok, invoices} = Invoice.search_by_account(client, "Account/account-123")
      {:ok, issued} = Invoice.search_by_status(client, "issued")
  """
