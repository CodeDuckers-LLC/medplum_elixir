defmodule Medplum.Resources.MedicationRequest do
  @moduledoc """
  Convenience helpers for FHIR `MedicationRequest` resource.

  ## Examples

      alias Medplum.Resources.MedicationRequest

      {:ok, meds} = MedicationRequest.search_by_subject(client, "Patient/patient-123")
      {:ok, active} = MedicationRequest.search_by_status(client, "active")
  """
