defmodule Medplum.Resources.CoverageEligibilityRequest do
  @moduledoc """
  Convenience helpers for FHIR `CoverageEligibilityRequest` resource.

  ## Examples

      alias Medplum.Resources.CoverageEligibilityRequest

      {:ok, requests} = CoverageEligibilityRequest.search_by_patient(client, "Patient/patient-123")
      {:ok, by_provider} = CoverageEligibilityRequest.search_by_provider(client, "Organization/org-123")
  """
