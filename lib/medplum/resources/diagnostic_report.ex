defmodule Medplum.Resources.DiagnosticReport do
  @moduledoc """
  Convenience helpers for FHIR `DiagnosticReport` resource.

  ## Examples

      alias Medplum.Resources.DiagnosticReport

      {:ok, reports} = DiagnosticReport.search_by_patient(client, "Patient/patient-123")
      {:ok, by_order} = DiagnosticReport.search_by_based_on(client, "ServiceRequest/service-request-123")
  """
  ...
  @spec search_by_based_on(Client.t(), String.t(), map()) :: Medplum.result()
  def search_by_based_on(%Client{} = client, based_on, params \\ %{}) do
    search(client, Map.merge(params, %{"based-on" => based_on}))
  end
end
