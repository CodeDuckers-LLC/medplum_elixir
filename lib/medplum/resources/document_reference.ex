defmodule Medplum.Resources.DocumentReference do
  @moduledoc """
  Convenience helpers for FHIR `DocumentReference` resource.

  ## Examples

      alias Medplum.Resources.DocumentReference

      {:ok, docs} = DocumentReference.search_by_patient(client, "Patient/patient-123")
      {:ok, encounter_docs} = DocumentReference.search_by_encounter(client, "Encounter/encounter-123")
  """
