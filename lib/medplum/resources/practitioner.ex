defmodule Medplum.Resources.Practitioner do
  @moduledoc """
  Convenience helpers for the FHIR `Practitioner` resource.

  ## Examples

      alias Medplum.Resources.Practitioner

      {:ok, doctor} = Practitioner.get(client, "practitioner-123")
      {:ok, created} = Practitioner.create(client, %{"active" => true})
  """
